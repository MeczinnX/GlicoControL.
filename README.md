...
<head>
    ...
    <title>Tratamentos Diabéticos em São Luis do Maranhão</title>
            ...
            <hr>
               ...
               <h1>Oque significa comer corretamento para você?</h1>
                ...
                <aside>
                    ...
                    <br>
                    <ul>
                    <li>• leguminosas, como feijão e lentilhas;</li>
                    <li>• OVOs;</li>
                    <li>• peixe;</li>
                    <li>• aves como frango e peru;</li>
                    <li>• nozes sem sal;</li>
                    </ul>
                </aside>
                <br>
                ...
                <ul>
                    <li>• carne vermelha e processada;</li>
                    <li>• ghee;</li>
                    <li>• manteiga;</li>
                    <li>• banha;</li>
                    <li>• biscoitos, bolos, tortas e doces;</li>
                </ul>
...
<br><br>
                  ...
                  <br> <br>
            <br>
           <strong> Então é isso! Espero que você tenha gostado do nosso artigo com essa curiosidade 
            sobre o tratamento e cuidado da Diabéte.</strong>           
        </article>    
     </main>
     <footer>
